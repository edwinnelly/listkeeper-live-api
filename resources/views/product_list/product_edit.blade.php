                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('products.edit.update', Crypt::encrypt($product->id)) }}" method="POST"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control sleek-input" id="sku"
                                                name="sku" placeholder="SKU" value="{{ old('sku', $product->sku) }}">
                                            <label for="sku">SKU</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control sleek-input" id="description" name="description" placeholder="Description"
                                ...
                                <div class="row g-3 mb-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <select class="form-select sleek-input" id="category" name="category_id"
                                                required>
                                                <option value="">Select Category</option>
                                                @foreach ($category as $pcategory)
                                                    <option value="{{ $pcategory->id }}"
                                                        {{ old('category_id', $product->category_id) == $pcategory->id ? 'selected' : '' }}>
                                                        {{ $pcategory->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row g-3 mb-4">
                                        ...
                                        <div class="form-floating">
                                            <select class="form-select sleek-input" id="unit" name="unit_id" required>
                                                ...
                                                @foreach ($units as $punits)
                                                    <option value="{{ $punits->id }}"
                                                        {{ old('unit_id', $product->unit_id) == $punits->id ? 'selected' : '' }}>
                                                        {{ $punits->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" class="form-control sleek-input" id="stockQty"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" class="form-control sleek-input" id="lowStockThreshold"
                                                name="low_stock_threshold" placeholder="Low Stock Threshold"
                                ...
                                <div class="row g-3 mb-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" step="0.01" class="form-control sleek-input"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="date" class="form-control sleek-input" id="expires_at"
                                                name="expires_at" value="{{ old('expires_at', $product->expires_at) }}">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-floating">
                                            <input type="text" class="form-control sleek-input" id="dimensions"
                                                name="dimensions" placeholder="Dimensions (L×W×H)"
                                ...
                                <div class="row g-3 mb-4">
                                        ...
                                        <div class="form-floating">
                                            <select class="form-select sleek-input" id="supplier" name="supplier_id">
                                                ...
                                                @foreach ($vendors as $pvendors)
                                                    <option value="{{ $pvendors->id }}"
                                                        {{ old('supplier_id', $product->supplier_id) == $pvendors->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <select class="form-select sleek-input" id="status" name="status"
                                                required>
                                                <option value="active"
