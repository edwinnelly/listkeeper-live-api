                        ...
                        <div class="container d-flex justify-content-center align-items-center min-vh-10 px-3">
                            <div class="card delete-card border-0 shadow-lg rounded-4 p-4 position-relative">
                                ...
                                <div class="text-center mb-4 z-1 position-relative">
                                    ...
                                    <h4 class="fw-bold text-danger">Delete Product Category</h4>
                                ...
                                <div
                                    ...
                                    <h5 class="text-danger fw-bold mb-0">{{ $fetchCateogry->name }}</h5>
                                </div>
                                ...
                                <!-- Confirm Input -->
                                    ...
                                    <div class="d-flex flex-column flex-sm-row gap-2">
                                        <a href="{{ route('products.category.index') }}" class="btn btn-outline-secondary w-100">
                                            <i class="bi bi-arrow-left-short me-1"></i> Cancel
                                        </a>

                                        <form action="{{ route('product.categories.destroy', Crypt::encrypt($fetchCateogry->id)) }}" method="POST"
                                            class="w-100">
                                            @csrf
                                            @method('DELETE')
