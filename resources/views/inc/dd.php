        ...
        <div id="sidebar-menu" class="sidebar-menu">
            {{-- <nav class="greedys sidebar-horizantal">
                <ul class="list-inline-item list-unstyled links">
                    ...
                    <li class="submenu">
                        <a href="home#"><i class="fe fe-home"></i> <span> Dashboard</span> <span
                    ...
                    <li class="submenu">
                        <a href="home"><i class="fe fe-grid"></i> <span> Applications</span> <span
                                class="menu-arrow"></span></a>
                        <ul>
                    ...
                    <li class="submenu">
                        <a href="dashboard.html#"><i class="fe fe-user"></i> <span> Super Admin</span> <span
                                class="menu-arrow"></span></a>
                        <ul>
                    ...
                    <li class="submenu">
                        <a href="dashboard.html#"><span> <i class="fe fe-users"></i> Customers</span> <span
                                class="menu-arrow"></span></a>
                        <ul>
                            <li><a href="customers.html"><i class="fe fe-users"></i>
                    ...
                    <li class="submenu">
                        <a href="dashboard.html#"><i class="fe fe-package"></i> <span> Products /
                    ...
                    <li class="submenu">
                        <a href="dashboard.html#"> <i class="fe fe-file-plus"></i><span>Signature </span>
                ...
                <ul class="hidden-links hidden">
                    ...
                    <li>
                        <a href="purchases.html"><i class="fe fe-shopping-cart"></i>
                    ...
                    <li>
                        <a href="debit-notes.html"><i class="fe fe-file-text"></i> <span>Debit
                                Notes</span></a>
                    </li>
                    ...
                    <li class="submenu">
                        <a href="dashboard.html#"><i class="fe fe-box"></i><span>Reports</span> <span
                                class="menu-arrow"></span></a>
                        <ul>
                    ...
                    <li class="submenu">
                        <a href="dashboard.html#"><i class="fe fe-book"></i> <span> Membership</span> <span
                                class="menu-arrow"></span></a>
                        <ul>
                    ...
                    <li class="submenu">
                        <a href="dashboard.html#"><i class="fe fe-book"></i> <span> Blog</span> <span
                                class="menu-arrow"></span></a>
                        <ul>
                    ...
                    <li class="submenu">
                        <a href="dashboard.html#"><i class="fe fe-map-pin"></i> <span> Location</span> <span
                                class="menu-arrow"></span></a>
                        <ul>
                    ...
                    <li class="submenu">
                        <a href="dashboard.html#"><i class="fe fe-save"></i> <span> Tickets</span> <span
                                class="menu-arrow"></span></a>
                        <ul>
                    ...
                    <li class="submenu">
                        <a href="dashboard.html#"><i class="fe fe-lock"></i> <span> Authentication </span>
                            <span class="menu-arrow"></span></a>
                        <ul>
                    ...
                    <li class="submenu">
                        <a href="dashboard.html#"><i class="fe fe-pocket"></i> <span>Base UI </span> <span
                                class="menu-arrow"></span></a>
                        <ul>
                    ...
                    <li class="submenu">
                        <a href="dashboard.html#"><i class="fe fe-box"></i> <span>Elements </span> <span
                                class="menu-arrow"></span></a>
                        <ul>
                    ...
                    <li class="submenu">
                        <a href="dashboard.html#"><i class="fe fe-bar-chart"></i> <span> Charts </span> <span
                                class="menu-arrow"></span></a>
                        <ul>
                    ...
                    <li class="submenu">
                        <a href="dashboard.html#"><i class="fe fe-award"></i> <span> Icons </span> <span
                                class="menu-arrow"></span></a>
                        <ul>
                    ...
                    <li class="submenu">
                        <a href="dashboard.html#"><i class="fe fe-sidebar"></i> <span> Forms </span> <span
                                class="menu-arrow"></span></a>
                        <ul>
                    ...
                    <li class="submenu">
                        <a href="dashboard.html#"><i class="fe fe-layout"></i> <span> Tables </span> <span
                                class="menu-arrow"></span></a>
                        <ul>
                    ...
                    <li>
                        <a href="dashboard.html#"><i class="fe fe-file-text"></i>
            ...
            <ul class="sidebar-vertical">
                ...
                <li class="menu-title"><span>Main</span></li>
                <li class="submenu">
                    <a href="home#"><i class="fe fe-home"></i> <span> Dashboard</span> </a>
                </li>
                ...
                <li>
                    <a href="customers.html"><i class="fe fe-users"></i> <span>Manage Business</span></a>
                </li>
                ...
                <!-- /Customers -->
                 ...
                 <li>
                     <a href="customer-details.html"><i class="fe fe-file"></i> <span>Task Automation</span></a>
                 </li>
                ...
                <li class="menu-title"><span>Inventory</span></li>
                <li class="submenu">
                    <a href="dashboard.html#"><i class="fe fe-package"></i> <span> Products / Services</span>
                        <span class="menu-arrow"></span></a>
                    <ul style="display: none;">
                        <li><a href="product-list.html">Product List</a></li>
                        <li><a href="category.html">Category</a></li>
                ...
                <li>
                    <a href="signature-list.html"><i class="fe fe-clipboard"></i> <span>List of
                            Signature</span></a>
                    <a href="signature-invoice.html"><i class="fe fe-box"></i> <span>Signature
                            Invoice</span></a>
                </li> --}}
                <!-- /Signature -->
                ...
                <li class="submenu">
                    ...
                    <a href="dashboard.html#"><i class="fe fe-file"></i> <span>Invoices</span><span
                            class="menu-arrow"></span></a>
                    <ul style="display: none;">
                        <li><a href="invoices.html">Invoices List</a></li>
                        <li><a href="invoice-details-admin.html">Invoice Details (Admin)</a></li>
