...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('roles', function (Blueprint $table) {
            ...
            $table->ulid('owner_id');  // FIXED: removed duplicate $table->
            ...
            $table->enum('can_view_cost', ['yes', 'no'])->default('no');
             ...
             // Transfer Products permissions
            $table->enum('can_transfer', ['yes', 'no'])->default('no');
            $table->enum('transfer_approve', ['yes', 'no'])->default('no');
            $table->enum('read_transfers', ['yes', 'no'])->default('no');
